...
// Add Heroku production URL
if (process.env.NODE_ENV === 'production') {
  apiOptions.server = 'herokuapp.com'
}
...
const showError = (req, res, status) => {
  ...
  if (status === 404) {
    ...
    content = 'Oh dear, look like you can\'t find this page. Sorry';
  } else {
...
const renderDetailPage = function(req, res, location) {
  res.render('location-info', {
    ...
    sidebar: {
      context: 'is on Loc8r because it has accessible wifi and space to sit down \
